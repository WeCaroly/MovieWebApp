        ...
        <td style="border:solid white 3px;">
            ...
            <div class="modal">
                ...
                <div class="modal__inner" style="text-align: center">
                    ...
                    <input readonly type="text" id="output<%=x%>" style="width: 100%; border:none;">
                    <%

                    //TODO: add in the get item
            ...
            <div class="modal">
                ...
                <div class="modal__inner" style="text-align: center">
                    ...
                    <form action="/moviePage" method="post" style="font-size: 24px; color: white; padding-top: 20px;">
                        <div>
                        <textarea name="Text" id="input<%=x%>" maxlength="550" cols="40" rows="5" placeholder="Write Review" style="width:100%; height: 70%;"></textarea>
